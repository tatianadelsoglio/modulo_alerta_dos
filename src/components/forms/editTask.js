...
const EditTask = ({ edit }) => {
  ...
  const { deal, task } = useContext(DealContext);
  ...
  const onChangeTimeFrom = (v) => {
    settimeFrom(moment(v).format("h:mm:ss"));
  };
          ...
          <div className="layout-wrapper">
            ...
            >
              <div className="layout-form">
                ...
                <Row gutter={[8, 8]}>
                  <Col span={12} style={{ display: "flex", marginTop: 15 }}>
                    <p>Contacto: </p>
                    <span style={{ marginLeft: 8 }}> {task.con_nombre}</span>
                  </Col>
                </Row>

                {/* <Form.Item label="Contacto" name="con_id" initialValue={task.con_nombre}>
									{getContactos.data && (
                        ...
                        >
                          <DatePicker
                            disabledDate={(current) =>
                              current.isBefore(
                                moment(task.tar_vencimiento).subtract(0, "day")
                              )
                            }
                ...
                <Note editValue={task.not_desc || ""}></Note>
                <Row gutter={[20, 20]}>
                  <Col sm={24}>
                    <Radio.Group
                      defaultValue={
                        task.not_importancia
                          ? String(task.not_importancia)
                          : "3"
                      }
                      buttonStyle="solid"
